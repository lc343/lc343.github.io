...
![Markdown](2.png)
## 二、offsetHeight和 offsetWidth##<br>
当前元素的父级元素有CSS定位，添加代码如下：
...
各个浏览器下的效果图如下：<br>
1.Chrome效果图<br>
1.![Markdown](2.1.png)<br>
2.Firefox效果图<br>
2.![Markdown](2.2.png)<br>
3.IE7/9效果图效果一样<br>
3.![Markdown](2.3.png)<br>
4.IE8效果图效果一样<br>
4.![Markdown](2.58.png)<br>
5.Opera效果图<br>
5.![Markdown](2.4.png)<br>
...
1.IE7效果图<br>
1.![Markdown](3.2.png)<br>
与之前父级元素CSS定位时的两个属性值相等。<br>
2.IE8/9效果图<br>
2.![Markdown](3.3.png)<br>
...
2.2Opera效果图如图所示：<br>
2.3![](4.3.png)<br>
2.3Firefox效果图如图所示：<br>
2.4![](4.4.png)<br>
2.4Firefox的offsetLeft和offsetLeft值不一样
...
3.Chrome效果图<br>
3.![Markdown](3.1.png)<br>
4.Firefox效果图<br>
4.![Markdown](4.5.png)<br>
